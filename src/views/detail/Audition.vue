<template>
  <div :class="$style.audition">
    ...
    <!-- 相关课程 -->
    <div class="slide-padding mt-80">
      <ModuleTitle title="相关课程" />
      <AuditionItem
        img="//gw.alicdn.com/bao/uploaded/i3/479184430/O1CN01ayHuQ81iaz4T6HTdm_!!0-item_pic.jpg_300x300q85s150_.webp"
        count="123"
