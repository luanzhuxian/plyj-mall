  ...
  >
    ...
    <pl-popup :show.sync="showInvioceIntro">
      ...
      <div class="invioceIntroContent">
        ...
        <p>1.2朋来雅集有权随时修改本协议条款，并遵守法定程序将其公示于网站，但无需征得您事先同意。修改后的条款应于公示或通知时立刻生效。在修改本协议后，您继续本功能则被视作，您已接受了修改后的条款</p>
        <h3>二、定义</h3>
        ...
        <p>4.5您同意本协议想内容，即同意商家采用微信企业发红包的方案，为您发送提现金额限制范围之内的红包；如果您在24小时内，未领取红包，视为放弃领取，则商家有权将红包金额返还到您的可提现金额中，您如还需提现需重新发起提现申请；</p>
        <h3>五、商家的义务</h3>
