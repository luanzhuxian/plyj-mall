        ...
        <div :class="$style.background">
            <div :class="$style.container" v-if="allLoaded">
                ...
                <section :class="[$style.live, $style.module]" v-if="isLiveShow">
                    <Panel
                        custom-class="spring-2021-red-live-panel"
                        title="直播放映室"
                ...
                <!-- 预购 -->
                <section :class="[$style.yugou, $style.module]" class="spring-2021-red-yugou" v-if="Yugou.showStatue === 1 && Yugou.values.length">
                    <Yugou :data="Yugou" />
                </section>
                <!-- 组合课 -->
