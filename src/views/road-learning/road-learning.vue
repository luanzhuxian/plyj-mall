<template>
  <div class="road-learning">
    ...
    <div class="learning-step">
      <i class="point small" />
      <i class="point large" />
      <div>连续签到<span>1</span>天，累计签到<span>2</span>天</div>
      <i class="point large" />
      <i class="point small" />
    </div>
    <div class="content">
      <div class="content-time">
        开始倒计时：<span>01</span>&nbsp;天&nbsp;<span>23</span>:<span>34</span>:<span>59</span>
      </div>
      <div class="content-step-box">
        ...
        <div class="step step10">
          <pl-icon name="icon-liwu" color="#FFF" size="30" />
        </div>
      </div>
      <div class="btn-box">
        <!--        <div class="btn disabel">活动未开始</div>-->
        <!--        <div class="btn active">立即签到</div>-->
        <div class="btn active">查看奖品</div>
        <!--        <div class="btn already">今日已签到</div>-->
      </div>
    </div>
          ...
          <div class="content-detail-box">
            <div class="content-box">
              <div content="content-detail">
                <p class="detail-name">CHERRY机械键盘</p>
