    ...
    <div :class="$style.pullLoading"
      ...
      <svg :class="$style.pullLoadingIcon"
        ...
        <path d="M16 0 A16 16 0 0 1 32 16 L28 16 A12 12 0 0 0 16 4z">
          <animateTransform attributeName="transform" type="rotate" :from="`${rotate} 16 16`" :to="`${360+rotate} 16 16`" :dur="loading ? '0.8s' : '99999s'" repeatCount="indefinite" />
        </path>
      </svg>
    </div>
