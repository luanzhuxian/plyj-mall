<template>
  <div :class="$style.infoHeader">
    <div :class="$style.priceLeft">
      ...
      <div :class="$style.tuanCount">
        <div :class="$style.count">
          <div :class="$style.original" v-if="false">
            <span :class="$style.text">原价</span>
            <del v-if="(minPrice !== maxPrice || maxOriginalPrice !== maxPrice) && maxOriginalPrice" v-text="maxOriginalPrice" />
          </div>
          <div :class="$style.original">
            <span :class="$style.text">现价</span>
            <span v-if="(minPrice !== maxPrice || maxOriginalPrice !== maxPrice) && maxOriginalPrice" v-text="maxOriginalPrice" />
          </div>
        ...
        <div :class="$style.join">
          <ul>
            <li :class="$style.avatar" v-for="k in 4" :key="k"><img src="../../assets/images/d12-tabbar.png"></li>
          </ul>
          205人和你一起参与
        </div>
      </div>
